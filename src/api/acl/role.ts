...
// 定义请求地址的枚举
enum Api {
  GetRoleList = '/acl/role',
  RemoveRole = '/acl/role/remove',
  RemoveRoles = '/acl/role/batchRemove',
  SaveRole = '/acl/role/save',
  UpdateRole = '/acl/role/update',
  AssignRole = '/acl/permission/doAssign',
  GetAssignRole = '/acl/permission/toAssign',
}
