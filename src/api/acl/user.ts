...
// 定义请求地址的枚举
enum Api {
  GetUserList = '/acl/user',
  RemoveUser = '/acl/user/remove',
  RemoveUsers = '/acl/user/batchRemove',
  SaveUser = '/acl/user/save',
  UpdateUser = '/acl/user/update',
  GetUserRoleList = '/acl/user/toAssign',
  AssignUserRoleList = '/acl/user/doAssign',
}
