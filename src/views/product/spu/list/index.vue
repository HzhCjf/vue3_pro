<template>
    <div >
        <el-button type="primary" icon="ele-Plus" style="margin: 20px 0;" @click="$emit('addSPUOrSKU',VIEWFORM.SPUFORM)" :disabled="!category3Id">添加SPU</el-button>
        ...
        <el-table :data="spuList" border stripe size="default" style="margin-bottom: 20px;">
            ...
            <el-table-column label="操作">
                <template #="{ row }">
                    <el-button type="success" icon="ele-Plus" title="添加sku" style="width: 40px;height: 30px;" @click="$emit('addSPUOrSKU',VIEWFORM.SKUFORM)"></el-button>
                    <el-button type="warning" icon="ele-Edit" title="修改spu" style="width: 40px;height: 30px;"></el-button>
